	...
	var e = function (u) {
		...
		u.ConfigCallbacks.registerAction(
			...
			i.extend(u.FilterGroup.prototype, {
				...
				handleFormEvent: function (e) {
					...
					if (
						...
						for (
							i = t.mixer.multifilterFormEventTracker =
								new u.MultifilterFormEventTracker(),
								i.form = e.target,
								l = 0;
			...
			u.Mixer.registerAction('afterSanitizeConfig', 'multifilter', function () {
				var u = this;
				(u.config.multifilter.logicBetweenGroups =
					u.config.multifilter.logicBetweenGroups.toLowerCase().trim()),
					(u.config.multifilter.logicWithinGroup =
						u.config.multifilter.logicWithinGroup.toLowerCase().trim());
			}),
