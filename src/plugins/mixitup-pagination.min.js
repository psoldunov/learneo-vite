	...
	var t = function (a) {
		...
		a.ConfigCallbacks.registerAction(
			...
			a.controlDefinitions.push(
				new a.ControlDefinition('pager', '[data-page]', !0, 'pageListEls')
			),
			...
			a.Mixer.registerAction('afterSanitizeConfig', 'pagination', function () {
				...
				t.config.pagination.limit < 0 ||
					...
					(t.config.callbacks.onMixStart = function (e, s) {
						(e.activePagination.limit === s.activePagination.limit &&
							e.activePagination.page === s.activePagination.page) ||
							(o = !0),
							...
							o &&
								(a.events.fire(
									'paginateStart',
									t.dom.container,
									{ state: e, futureState: s, instance: t },
									t.dom.document
								),
				...
				function (t) {
					...
					return i.config.pagination.limit < 0
						...
						: ((t.activePagination = new a.CommandPaginate()),
						  ...
						  (t.activePagination.limit = i.config.pagination.limit),
						  t);
				}
			),
			...
			a.Mixer.registerAction('afterCacheDom', 'pagination', function () {
				...
				if (
					...
					(t.dom.pageListEls = i.querySelectorAll(t.config.selectors.pageList)),
			...
			a.Mixer.registerFilter(
				...
				function (t) {
					...
					return i.config.pagination.limit < 0
						? t
						: (!t.command.paginate ||
								t.command.paginate instanceof a.CommandPaginate ||
					...
					if (!(t.config.pagination.limit < 0)) {
						if (
							((a.newTotalPages = a.newPagination.limit
								? Math.max(
										Math.ceil(a.matching.length / a.newPagination.limit),
										1
								  )
								: 1),
							...
							for (
								r = 0;
								(o = a.matching[r]) && o.dom.el !== a.newPagination.anchor;
								r++
							);
							(i = r), (e = r + a.newPagination.limit - 1);
						} else
							(i = a.newPagination.limit * (a.newPagination.page - 1)),
								(e = a.newPagination.limit * a.newPagination.page - 1),
								isNaN(i) && (i = 0);
						if (!(a.newPagination.limit < 0)) {
							...
							for (r = 0; (o = s[r]); r++)
								a.hide.push(o),
									(g = a.toShow.indexOf(o)) > -1 && a.toShow.splice(g, 1),
						  ...
						  e.paginate
								...
								: (e.filter || e.sort) &&
								  ...
								  n.config.pagination.maintainActivePage
										? (t.newPagination.page = n.state.activePagination.page)
			...
			a.Mixer.extend({
				parsePaginateCommand: function (t, i) {
					...
					if (t.page > -1) {
						if (0 === t.page)
							throw new Error(a.messages.ERROR_PAGINATE_INDEX_RANGE);
					...
					t.limit > -1 && (i.newPagination.limit = t.limit),
						i.newPagination.limit !== i.startPagination.limit &&
							(i.newTotalPages = i.newPagination.limit
								...
								: 1),
						(i.newPagination.limit <= 0 || i.newPagination.limit === 1 / 0) &&
					...
					for (
						s = e.newPagination.page - 1,
							...
							n.config.pagination.maxPagers < 1 / 0 &&
								e.newTotalPages > n.config.pagination.maxPagers &&
						...
						(o = n.renderPager(d, e, c)),
							o || (d < s && p) || (d > s && m)
								...
								: ((r = new a.ModelPager()),
								  ...
								  (o = l
										? l(r)
										: i.template(n.config.templates.pagerTruncationMarker)(r)),
								  g.push(o),
								  d < s && (p = !0),
								  d > s && (m = !0));
					for (
				...
				renderPager: function (t, e, n) {
					...
					return s.config.pagination.maxPagers < 1 / 0 &&
						...
						? ''
						: ((o =
								'function' == typeof (o = s.config.render.pager) ? o : null),
						  (r.isPageLink = !0),
				...
				renderPageStatsEl: function (t, e) {
					...
					return e.newPagination.limit < 0 ||
						...
						: ((o =
								'function' == typeof (o = n.config.render.pageStats)
									? o
									: null),
						  ...
						  s.totalTargets && e.newPagination.limit > 0
								? ((s.startPageAt =
										(e.newPagination.page - 1) * e.newPagination.limit + 1),
								  (s.endPageAt = Math.min(
										s.startPageAt + e.newPagination.limit - 1,
										s.totalTargets
								  )))
						  ...
						  (t.innerHTML = g),
						  void (s.totalTargets
								? i.removeClass(t, n.classNamesPageStats.disabled)
								: i.addClass(t, n.classNamesPageStats.disabled)));
				},
